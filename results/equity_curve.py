...
class MatlibPlotResults(object):
    ...
    def display(self, context):
        ...
        date = [mdates.date2num(o[0]) for o in performance]
        closep = [float(o[1]) for o in performance]
        algorithmPerformance = [float(o[2]) for o in performance]
        ...
        rsi = Financial.rsi(np.array(closep))
        pad = np.asarray([0] * (len(date) - len(rsi)))
        ...
        ax0.plot(date, rsi, rsiCol, linewidth=1)
